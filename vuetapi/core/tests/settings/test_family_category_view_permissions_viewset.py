...
from core.views.settings_views import FamilyCategoryViewPermissionViewset
from rest_framework.test import APIRequestFactory, force_authenticate


class TestFamilyCategoryViewPermissionViewset(TestCase):
    def setUp(self):
        self.create_view = FamilyCategoryViewPermissionViewset.as_view({"post": "create"})

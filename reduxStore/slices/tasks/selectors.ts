...
export const selectTasksByEntityId = (
  entityId: number | string
): Selector<EntireState, TaskResponseType[]> => {
  ...
  return createSelector(selectTaskState, (tasks: TasksState) =>
    Object.values(tasks.allTasks.byId).filter(

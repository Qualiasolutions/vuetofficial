...
import { PageSubtitle, PageTitle, PrimaryText } from "components/molecules/TextComponents";
  ...
  return <TransparentPaddedView>
    {
      userDetails.is_premium
        ? <TransparentView>
          <PageTitle
            text={`${t("screens.editAccountType.currentAccountType")}: ${t("screens.editAccountType.premiumPlan")}`}
          />
        ...
        : <TransparentView>
          <PageTitle
            text={`${t("screens.editAccountType.currentAccountType")}: ${t("screens.editAccountType.standardPlan")}`}
          />

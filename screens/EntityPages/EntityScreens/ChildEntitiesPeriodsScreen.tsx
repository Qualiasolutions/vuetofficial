/*
  ChildEntitiesPeriodsScreen - this is a calendar component for displaying periods filtered to
...
export default function ChildEntitiesPeriodsScreen({
  ...
  return <EntityPeriodsPage entityIds={childEntities.map((ent) => ent.id)} />;
}

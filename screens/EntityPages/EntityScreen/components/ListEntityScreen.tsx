...
import { TransparentContainerView, WhiteBox } from 'components/molecules/ViewComponents';
...
import { useCreateListEntryMutation, useDeleteListEntryMutation, useUpdateListEntryMutation } from 'reduxStore/services/api/lists';
    ...
    <ScrollView>
      <TransparentContainerView>
        ...
        <TextInput
          ...
          blurOnSubmit={false}
          onSubmitEditing={() => createListEntry({
            list: entityData.id,
            title: newEntryTitle
          }).then(() => {
            setNewEntryTitle('')

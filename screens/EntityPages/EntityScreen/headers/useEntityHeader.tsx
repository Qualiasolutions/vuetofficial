  ...
  useLayoutEffect(() => {
    if (entity) {
      const HeaderRightComponent =
        Object.keys(headerRightMapping).includes(entity.resourcetype)
      ...
      const HeaderBackgroundComponent =
        Object.keys(headerBackgroundMapping).includes(entity.resourcetype)
      ...
      const headerTintColor =
        Object.keys(headerTintColorMapping).includes(entity.resourcetype)
          ? headerTintColorMapping[entity.resourcetype]
          : headerTintColorMapping.default;
  
      const HeaderComponent =
        Object.keys(headerMapping).includes(entity.resourcetype)
